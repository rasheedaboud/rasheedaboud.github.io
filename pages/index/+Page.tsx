      ...
      <div className='grid auto-rows-max sm:grid-col-3  sm:grid-flow-row lg:grid-rows-3  lg:grid-flow-col sm:gap-4 sm:py-5 '>
        ...
        <div className='py-5 lg:row-span-2 text-slate-700 font-semibold fade-in-right'>
          <p>
            ...
            (TypeScript), and more, I bring a wealth of knowledge to the table.
          </p>
          <br />
          <p>
            Specializing in Web development, I take pride in building robust and
            scalable applications. If you&apos;re in need of a highly skilled
            developer who can bring your projects to life with a mix of
            creativity, efficiency, and a touch of finesse, look no further.
